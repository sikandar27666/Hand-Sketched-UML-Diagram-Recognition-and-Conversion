...
project = rf.workspace().project("class-diagram-negxg")
...
def save_bounding_boxes(image_path, confidence=40, overlap=30):
    ...
    try:
        ...
        for conn in yolo_data.get("connections", []):
            ...
            if from_id and to_id:
                if conn_type == "association" or conn_type=="one-way-association":
                    writer.write_line(
